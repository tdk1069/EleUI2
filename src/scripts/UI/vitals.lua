...
--display(gmcp.Char.Vitals)
    ...
    --
    hpbar.text:echo([[<span style="font-family: 'Game Played';font-size:15px;">&nbsp;HP:]] .. gmcp.Char.Vitals.hp .. [[/<span style="font-size:13px">]] .. gmcp.Char.Vitals.maxhp ..[[</span>]])
    mpbar.text:echo([[<span style="font-family: 'Game Played';font-size:15px;">&nbsp;MP:]] .. gmcp.Char.Vitals.mp .. [[/<span style="font-size:13px">]] .. gmcp.Char.Vitals.maxmp ..[[</span>]])
    spbar.text:echo([[<span style="font-family: 'Game Played';font-size:15px;">&nbsp;SP:]] .. gmcp.Char.Vitals.sp .. [[/<span style="font-size:13px">]] .. gmcp.Char.Vitals.maxsp ..[[</span>]])
